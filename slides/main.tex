...
% % % % ------------------------ Recap ----------------------
\begin{frame}{Continuing BTP-1 work....Recap}

    \textbf{What was done in BTP-1:}
    \begin{itemize}
	\item Last sem the work focused on understanding different PSOs.	
	\item Implementing \cite{10312321}. 
	\item Doing exploring based source seeking for APSO, ARPSO, SPSO.
    \end{itemize}

    \textbf{What is plan for BTP-2:}
    \begin{itemize}
	\item This sem target is to try exploitation strategies in source seeking
		algos and observe behaviours of different PSOs
	\item To identify which PSO or combination of different PSOs work best in which scenario.
    \end{itemize}
\end{frame} 
% % % % ------------------------ PSO ------------------------
\begin{frame}{PSO}
